      ...
      >
        <div className="max-w-[1180px] mx-auto flex items-center justify-between gap-4">
          <Link href="/" className="flex items-center gap-2">
            <span className="text-xl font-bold text-[#132a52]">₿ AfriSend</span>
          </Link>
          ...
          <div className="hidden md:flex items-center gap-3 text-sm text-[#5f6f88]">
            <button className="hover:text-[#132a52]">🔔</button>
            <div className="h-8 w-8 rounded-full bg-gradient-to-br from-[#ff7448] to-[#c7365f] text-white grid place-items-center text-xs font-bold">
              WM
            </div>
            <button className="hover:text-[#132a52]">Settings</button>
          </div>

          <button
            className="md:hidden text-[#5f6f88]"
